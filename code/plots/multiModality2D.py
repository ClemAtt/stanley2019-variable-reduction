...
class get_turbine_locs(Component):
    ...
    def solve_nonlinear(self, params, unknowns, resids):
        ...
        rotated = 0.0
        startd = 0.0
        turbineX, dx_ddx, turbineY, dy_ddx = param_fortran.turbinelocations_dv(
            self.nTurbines,
            self.nOuter,
            self.nGrid,
            dx,
        ...
        rotated = 0.0
        startd = 0.0
        turbineX, dx_ddy, turbineY, dy_ddy = param_fortran.turbinelocations_dv(
            self.nTurbines,
            self.nOuter,
            self.nGrid,
            dx,
        ...
        rotated = 0.0
        startd = 0.0
        turbineX, dx_dshear, turbineY, dy_dshear = param_fortran.turbinelocations_dv(
            self.nTurbines,
            self.nOuter,
            self.nGrid,
            dx,
        ...
        rotated = 1.0
        startd = 0.0
        turbineX, dx_drotate, turbineY, dy_drotate = param_fortran.turbinelocations_dv(
            self.nTurbines,
            self.nOuter,
            self.nGrid,
            dx,
        ...
        rotated = 0.0
        startd = 1.0
        turbineX, dx_dstart, turbineY, dy_dstart = param_fortran.turbinelocations_dv(
            self.nTurbines,
            self.nOuter,
            self.nGrid,
            dx,
...
if __name__ == "__main__":
    ...
    cm.register_cmap(name="custom", data={"C0": [(0.0, 0, 0), (1.0, 0, 0)]})
    ...
    for i in range(100):
        for j in range(100):
            ss, _, bd, _ = constraints.constraints_position_dv(
                np.array(X[i][j]),
                np.array([0.0]),
                np.array(Y[i][j]),
                np.array([0.0]),
    ...
    ax1.pcolormesh(X, Y, aep, cmap="coolwarm", vmin=0.0, vmax=0.8, shading="gouraud")
    X = np.ndarray.flatten(X)
    Y = np.ndarray.flatten(Y)
    ...
    ax2.plot_trisurf(
        X, Y, aep, cmap="coolwarm", vmin=0.0, vmax=0.8, alpha=1.0, edgecolors=None
    )

    # ax1.set_clim(826558.17322674,836017.35050665)

    ax2.plot_wireframe(
        X, Y, aep, color="black", linewidth=2.0, alpha=0.024, rstride=1, cstride=1
    )
    ...
    ax2.set_ylim3d(-1800.0, 1800.0)
    ax2.set_xlim3d(-2100.0, 2100.0)
    # ax2.axis('equal')
    ...
    #
    ax1.text(-3200.0, 3200.0, "a", fontsize=11, color="black")
    ax2.text(-1300.0, 4980.0, np.max(aep), "b", fontsize=11, color="black")
